                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        new Movie()
                        {
                            ...
                            CinemaId = 3,
                            ProducerId = 3,
                            MovieCategory = MoviesCategory.Documentary
                        },
                        new Movie()
                        {
                            ...
                            CinemaId = 1,
                            ProducerId = 1,
                            MovieCategory = MoviesCategory.Action
                        },
                        new Movie()
                        {
                            Name = "Ghost",
                            ...
                            CinemaId = 4,
                            ProducerId = 4,
                            MovieCategory = MoviesCategory.Horror
                        },
                        new Movie()
                        {
                            Name = "Race",
                        ...
                        new Movie()
                        {
                            ...
                            CinemaId = 1,
                            ProducerId = 3,
                            MovieCategory = MoviesCategory.Cartoon
                        },
                        new Movie()
                        {
                            Name = "Cold Soles",
                            ...
                            CinemaId = 1,
                            ProducerId = 5,
                            MovieCategory = MoviesCategory.Drama
                        }
                    });
                    context.SaveChanges();
                }
        ...
        public static async Task seedUserAndRoleAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (appUser == null)
                {
                    ...
                    await userManager.CreateAsync(appUser, "P@ssword1");
